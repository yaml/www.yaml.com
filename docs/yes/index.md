...
But like many critical open source projects, YAML stack dependencies have relied on volunteer maintenance. **The YES Program changes that.**
...
For YAML libraries, the answer is simple: we are. The YAML Company is led by YAML's co-creator, and we maintain the libraries that power Kubernetes, Ansible, and your entire stack.

YES members can tell auditors exactly who maintains the YAML in their stack—and prove it.
...
- **Enterprise-grade security** with early security notifications and fix timelines
- **Strategic influence** to help decide what YAML builds next
- **Expert support** for the YAML in your stack
...
- :material-shield-check:{ .lg .middle } **Security First**
    ...
    48-hour early security notifications and security bulletins with fix timelines

- :material-vote:{ .lg .middle } **Roadmap Influence**

    Help decide what YAML builds next and shape YAML's evolution

- :material-forum:{ .lg .middle } **Member Forum**

    Access to exclusive YES member forum and quarterly virtual town halls

- :material-badge-account:{ .lg .middle } **Recognition**
...
=== "YES Member"
    ...
    **Core benefits + Choose 2:**
    ...
    - Beta access to new features
    - Monthly planning sessions for input on what gets built

    **Investment:** $25K/year

    [Learn More →](member.md){ .md-button .md-button--primary }
...
=== "YES Partner"
    ...
    **Investment:** $50K/year
    ...
    [Learn More →](partner.md){ .md-button .md-button--primary }
...
=== "YES Leader"
    ...
    **Investment:** $100K/year
    ...
    [Learn More →](leader.md){ .md-button .md-button--primary }

    Questions? Email [yes@yaml.com](mailto:yes@yaml.com)

</div>

[Compare All Benefits →](benefits.md){ .md-button }
...
**Strategic Influence**: Help decide what YAML builds next for the stack that powers your business. Ensure your needs are prioritized.
...
- Any organization where **YAML is mission-critical in your stack**
...
- **[go-yaml](../projects/go-yaml.md)** - Powers Kubernetes, Helm, and Kustomize
- **[pyyaml](../projects/pyyaml.md)** - Foundation of Ansible and Python's YAML ecosystem
- **[libyaml](../projects/libyaml.md)** - Fast C library used by many implementations
- **[YAMLScript](../projects/yamlscript.md)** - Next-generation YAML programming language

---

## Ready to Join?

[Contact Us About YES →](contact.md){ .md-button .md-button--primary }

[Compare Tiers & Benefits →](benefits.md){ .md-button }

---

## Frequently Asked Questions

??? question "How does the 'choose your benefits' model work?"
...
??? question "What happens if we don't use all our support hours?"
...
??? question "How do early security notifications work?"
...
??? question "Is YES just another donation platform?"
...
??? question "What about open source values?"
