...
go-yaml is maintained through the [YES Program](../yes/index.md). YES members get:
...
- [:octicons-mark-github-16: GitHub Repository](https://github.com/yaml/go-yaml)
- [:octicons-book-16: Documentation](https://pkg.go.dev/gopkg.in/yaml.v3)
- [:octicons-issue-opened-16: Issue Tracker](https://github.com/yaml/go-yaml/issues)
- [:octicons-people-16: Community](https://github.com/yaml/go-yaml/discussions)
