...
-   :simple-go:{ .lg .middle } **[go-yaml](go-yaml.md)**

    ---

    The YAML library that powers Kubernetes, Helm, Kustomize, and the entire Go ecosystem

    [:octicons-arrow-right-24: Learn more](go-yaml.md)

-   :simple-python:{ .lg .middle } **[pyyaml](pyyaml.md)**

    ---

    The foundation of Ansible, Salt, and Python's YAML ecosystem

    [:octicons-arrow-right-24: Learn more](pyyaml.md)

-   :simple-c:{ .lg .middle } **[libyaml](libyaml.md)**
...
The [YES Program](../yes/index.md) provides sustainable funding for:
...
The YAML Company also has authority over the [YAML specification](https://yaml.org/spec/) itself:
...
[Learn About the YES Program →](../yes/index.md){ .md-button .md-button--primary }
